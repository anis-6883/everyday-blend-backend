...
import { emailValidation, nameValidation, passwordValidation, providerValidation } from "../validations";
const router = express.Router();

router.post(
  "/register",
  [nameValidation, emailValidation, passwordValidation, providerValidation],
